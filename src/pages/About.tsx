  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-4">
      <motion.h1
        ...
        className="text-3xl md:text-3xl font-extrabold text-center mb-2 ">
        About Me
      </motion.h1>
        ...
        <div>
          ...
          <div className="space-y-6 pl-2 py-6">
            <motion.div
              ...
              <span className="text-gray-800 text-lg">Coffee enthusiast & night owl</span>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              <span className="text-gray-800 text-lg">5+ years of development experience</span>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              <span className="text-gray-800 text-lg">20+ projects delivered successfully</span>
            </motion.div>
          </div>
        </div>
        <div>
