        ...
        <div className="grid md:grid-cols-2 gap-8">
          {skills.map((skill, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-6 bg-card backdrop-blur-lg rounded-2xl shadow-lg border border-border hover:scale-[1.03] transition-all duration-300"
            >
              <div className="flex items-center gap-5 mb-6">
                <div className={`p-4 rounded-xl bg-gradient-to-r ${skill.color} shadow-lg`}>
                ...
                <motion.div
                  ...
                  className="ml-auto w-12 h-12 rounded-full bg-foreground text-background flex items-center justify-center text-sm font-bold shadow-inner"
                >
                  {skill.level}%
                </motion.div>
              </div>
